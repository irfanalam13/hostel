...
// Minimal structural shapes these helpers operate on. Domain types (e.g.
// features/hostels) satisfy them implicitly, keeping this package free of
// app/feature dependencies.
export type Payment = { date: string; studentId: string; amount: number };
export type Expense = { date: string; amount: number };
export type Student = {
  id: string;
  fullName: string;
  monthlyFee: number;
...
export type Bed = { id: string; roomId: string };
