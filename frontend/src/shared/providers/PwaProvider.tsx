...
import { applyUpdate as applySwUpdate, isStandalone, registerServiceWorker } from "@/shared/pwa/register";
import { initOutboxAutoFlush, pendingCount } from "@/shared/pwa/outbox";
import { autoCleanupIfNeeded } from "@/shared/pwa/storage";
import { flush as flushAnalytics, initAnalytics, track } from "@/shared/pwa/analytics";
import { PwaShell } from "@/shared/pwa/components/PwaShell";
import { installTrustedTypes } from "@/shared/security/trustedTypes";
import {
  dispatchBackgroundTask,
  initBackgroundTasks,
  type BackgroundTaskId,
} from "@/shared/pwa/backgroundTasks";
